...
import static com.techupstudio.GeneralUtils.Funcs.print;
...
public class BinaryTree<T>{
    ...
    private List<BinaryTree.Node<T>> nodeList = new ArrayList<>();
    ...
    public List<BinaryTree.Node<T>> toListInOrder(){
        nodeList.clear();
        buildArray(HEAD);
        return nodeList;
    }
