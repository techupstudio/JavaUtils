...
import com.techupstudio.GeneralUtils.Funcs;

import java.util.List;

import static com.techupstudio.GeneralUtils.Funcs.range;
import static com.techupstudio.GeneralUtils.Funcs.shuffle;
import static com.techupstudio.GeneralUtils.Funcs.toDouble;
...
public class StatsArray extends MasterList<Double> {
    ...
    private Double[] getSorted(){ return new Funcs.SortedNumArray(toDouble(super.toArray())).toDouble(); }
    ...
    public double getMean(){ return  getSum()/super.size(); }
    ...
    public double getSum(){
        double total = 0.0;
        for (int i : range(super.size())) { total += super.pop(i); }
        return total;
    }
    ...
    public double getMedian(){
        ...
        else{ if (size() == 1){ mMedian = super.pop(0); } }
        return mMedian;
    }
