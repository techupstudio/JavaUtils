 ...
 */
public class Noun {
    public static HashMap<String, Object> irregularSingulars = new HashMap<>(100);
    public static HashMap<String, Object> irregularPlurals = new HashMap<>(100);
    ...
    static {
        ...
        List<String> dice = Arrays.asList("dies", "dice");
        ...
        List<String> hoof = Arrays.asList("hooves", "hoofs");
        ...
        List<String> octopus = Arrays.asList("octopodes", "octopi", "octopuses");
        ...
        List<String> scarf = Arrays.asList("scarves", "scarfs");
        ...
        List<String> axes = Arrays.asList("axe", "axis");
...
// word is not irregular, and ends in -s but not -ss
    ...
    public static String pluralOf(String word) {
        ...
        if (singularLookup != null) {
            if (singularLookup instanceof List)
                return (String) (((List) singularLookup).get(0));
    ...
    public static String singularOf(String word) {
        ...
        if (pluralLookup != null) {
            if (pluralLookup instanceof List)
                return (String) (((List) pluralLookup).get(0));
