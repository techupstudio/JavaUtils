package com.techupstudio.otc_chingy.mychurch.core.utils.general.language;
...
public class Inflector {
    ...
    protected void initialize() {
        ...
        inflect.addPluralize("(zoo)$", "$1s");
        inflect.addPluralize("(a|e|i|o|u)s$", "$1ses");
        ...
        inflect.addPluralize("(al|at|t|b|c|d|f|g|h|j|k|l|m|p|r|s)o$", "$1oes");
        ...
        inflect.addPluralize("([lr])f$", "$1ves");
        inflect.addPluralize("([^f])fe$", "$1ves");
        inflect.addPluralize("(ca)fe$", "$1fes");
        inflect.addPluralize("([aeiou])f$", "$1ves");
        inflect.addPluralize("(lea)f$", "$1ves");
        ...
        inflect.addSingularize("(i)s$", "$1s"); // '-us' and '-ss' are already singular
        ...
        inflect.addSingularize("(.*)es$", "$1");
        inflect.addSingularize("(af|b|c|t|d|g|h|i|j|k|l|n|m|o|p|q|s|u|v|w|x|y|z)es$", "$1e");
        inflect.addSingularize("([aeiou]s)es$", "$1");
        inflect.addSingularize("(x|ch|ss|sh)es$", "$1");
        inflect.addSingularize("([aeiou])es$", "$1e");
        inflect.addSingularize("(p|t|b|c|d|g|h|j|l|[^aeiouy]|qu)ies$", "$1ie");
        inflect.addSingularize("(s|r|pp|k|n|(([aeiou])t))ies$", "$1y");
        inflect.addSingularize("(m|n)ies$", "$1ey");
        inflect.addSingularize("(mm|nn)ies$", "$1y");
        inflect.addSingularize("(o)es$", "$1");
        inflect.addSingularize("(shoe)s$", "$1");
        inflect.addSingularize("(ache)s$", "$1");
        ...
        inflect.addSingularize("(mo|o)ves$", "$1ve");
        inflect.addSingularize("((ea)|[lr]|hoo)ves$", "$1f");
        ...
        inflect.addIrregular("alumnus", "alumni");
        inflect.addIrregular("alumna", "alumnae");

        inflect.addUncountable("equipment", "grouse", "food", "milk", "wine",
